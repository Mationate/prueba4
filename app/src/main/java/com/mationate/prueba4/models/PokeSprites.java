...
public class PokeSprites implements Serializable {
    ...
    private String back_female, back_shiny_female, back_default,
            front_female,front_shiny_female,back_shiny, front_default, front_shiny;
    ...
    public List<String> getSprites() throws NoSuchFieldException, IllegalAccessException {
        Field[] fields = getClass().getDeclaredFields();
        List<String> list = new ArrayList<>();
        for (Field field : fields) {
            Field byName = getClass().getDeclaredField(field.getName());
            Object value = byName.get(this);
            if (value != null) {
                String sprite = (String) value;
                list.add(sprite);
            }
        }
        return list;
